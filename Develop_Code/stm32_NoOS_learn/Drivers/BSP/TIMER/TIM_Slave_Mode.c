...
TIM_SlaveConfigTypeDef g_TIM_Slave_Handle = {0};
    ...
    #if TIM_ETR_GPIO
        static void GPIO_ETR_SlaveGated_CHx_Init(void);
    #elif TIM_TI1_GPIO
        static void GPIO_TI1_SlaveGated_CHx_Init(void);
    #endif
...
HAL_StatusTypeDef TIM_SlaveGated_Mode_Init(TIM_HandleTypeDef *pBaseStr, TIM_SlaveConfigTypeDef *pSlaveStr,nTIM_IC_InitTypeDef *pICStr)
{
    ...
    if(HAL_TIM_Base_Init(&g_TIM_SlaveGated_Base_Handle) != HAL_OK)
    {
    ...
    //更新中断函数
    HAL_TIM_Base_Start_IT(&g_TIM_SlaveGated_Base_Handle);
...
void HAL_TIM_Base_MspInit(TIM_HandleTypeDef *htim)
{
    ...
    #if TIM_ETR_GPIO
        GPIO_ETR_SlaveGated_CHx_Init(); // 初始化GPIO
    #elif TIM_TI1_GPIO
        GPIO_TI1_SlaveGated_CHx_Init(); // 初始化GPIO
    #endif /* TIM_ETR_GPIO */
#if TIM_IT_ENABLE
