#ifndef __TIM_OC_ACTIVE_MODE_H_
#define __TIM_OC_ACTIVE_MODE_H_
...
#define TIM_OC_ACTIVE_MODE_ENABLE                    (0) // 0: 匹配无效模式，1：匹配有效模式
...
extern void TIM_OC_Active_Mode_Init(NEW_TIM_HandleTypeDef *pBaseStr, TIM_OC_InitTypeDef *pOCInitStr);
static void LED_Display_init(void);
static void GPIO_OC_CHx_Init(void);
static void DMA_OC_CHx_Init(TIM_HandleTypeDef *htim);

#endif /* __TIM_OC_ACTIVE_MODE_H_ */
