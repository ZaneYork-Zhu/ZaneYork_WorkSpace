...
3. Instructions
    ...
    2. LED1/LED2 indicates the connection status, and lights up when Bluetooth is connected.
        ...
        Test steps:
        1. Prepare two N32WB031_STB Development board and a mobile phone.
...
5. Download slave routines to another development board (slave development board). 
    Project path: \ble\rdtss\MDK-ARM\rdtss.uvprojx. The slave device ble name is "NS_RDTSS".
    ...
    5.2 Use APP to scan BLE devices and connect devices "NS_RDTS_RELAY ", when the relay development 
...
6. Download slave routines to another development board (slave development board). Project path:
    N32WB03x_SDK\projects\n32wb03x_EVAL\ble\rdtss\MDK-ARM\rdtss.uvprojx. 
    Use the default Bluetooth MAC address: "x0C x02 x03 x04 x05 x06", change the 
    6.1 Use APP to scan BLE devices and connect devices "NS_RDTS_RELAY ", when the relay development board 
    ...
    6.3 Enable NS_RDTSS Notify permission of the second notify feature of RELAY on mobile.
    6.4 On the mobile phone APP, turn to NS_RDTS_Write data in the second write feature of RELAY: 01000C0203040507
    6.5 When the relay development board LED1 lights up, it indicates that the connection with the slave is successful.

    7. Enable NS_RDTSS Notify permission of the first notify feature of RELAY on mobile APP.
