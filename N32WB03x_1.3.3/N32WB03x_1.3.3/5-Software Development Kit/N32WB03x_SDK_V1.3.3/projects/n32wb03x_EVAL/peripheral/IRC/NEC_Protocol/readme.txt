...
3. Instructions for use
    ...
    Instructions:
        1. Download after compiling and reset to run the program, check the wave of PB4.
		2. We can connect the IR led board to PB4 then check the data receive from IR receiver.
